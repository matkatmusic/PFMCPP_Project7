...
struct Character
{
    ...
    {
        armor += amount;
        std::cout << getName() << "'s armor level has been boosted to " << armor
                  << std::endl;
    }
    ...
    {
        hitPoints += amount;
        std::cout << getName() << "'s hit point level has been boosted to "
                  << hitPoints << std::endl;
    }
    ...
    {
        attackDamage += amount;
        std::cout << getName() << "'s attack damage level has been boosted to "
  ...
  private:
    std::unique_ptr<int> initialHitPoints, initialArmorLevel,
        initialAttackDamage;
